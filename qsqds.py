...
def ficheinfo( selected_id):
    ...
    image_label = ttk.Button(frame, image=photo_image)
    image_label.pack(side='left', anchor='nw')
    isbn_label = ttk.Button(frame, text="ISBN: {}".format(book[7]))
    title_label = ttk.Button(frame, text="Title : {}".format(book[1]))
    author_label = ttk.Button(frame, text=" Author: {}".format(book[2]))
    genre_label = ttk.Button(frame, text=" Genre: {}".format(book[3]))
    language_label = ttk.Button(frame, text=" Langue: {}".format(book[4]))
    year_label = ttk.Button(frame, text="année: {}".format(book[5]))
    csp_label = ttk.Button(frame, text="Contemplation sur place: {}".format(book[6]))
