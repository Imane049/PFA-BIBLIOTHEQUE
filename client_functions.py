...
def show_client(selected_id):
    ...
    id_label = ttk.Label(ClientInfo, text="ID: {}".format(client[0]))
    pname_label = ttk.Label(ClientInfo, text="Personal name : {}".format(client[1]))
    fname_label = ttk.Label(ClientInfo, text=" Family Name: {}".format(client[2]))
    username_label = ttk.Label(ClientInfo, text=" Username: {}".format(client[8]))
    password_label = ttk.Label(ClientInfo, text=" Password: {}".format(client[3]))
    age_label = ttk.Label(ClientInfo, text="Age: {}".format(client[4]))
    address_label = ttk.Label(ClientInfo, text="Address: {}".format(client[5]))
    phone_label = ttk.Label(ClientInfo, text="Phone: {}".format(client[6]))
    email_label = ttk.Label(ClientInfo, text="Email: {}".format(client[7]))
