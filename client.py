...
def client_root():
    ...
    ManageReservations_tab=ttk.Frame(tabControl)
    ManageAccount_tab=ttk.Frame(tabControl)

    tabControl.add(BrowseBooks_tab, text="Browse Books")
    tabControl.add(ManageReservations_tab, text="Manage reservations")
...
##SET BrowseBooks TAB
    ...
    contemplation_options_frame = tk.Frame(search_options_frame)
    contemplation_checkbutton = ttk.Radiobutton(search_options_frame, text="Contemplation sur place", variable=search_type, value="contemplation_sur_place")
    contemplation_checkbutton.pack(side="left", padx=2)

    contemplation_label = ttk.Label(contemplation_options_frame, text="Chose option:")
    contemplation_label.pack(side="left", padx=2)

    contemplation_option = tk.StringVar()
    contemplation_yes_checkbutton = ttk.Radiobutton(contemplation_options_frame, text="Yes", variable=contemplation_option, value="yes")
    contemplation_yes_checkbutton.pack(side="left", padx=2)

    contemplation_no_checkbutton = ttk.Radiobutton(contemplation_options_frame, text="No", variable=contemplation_option, value="no")
    contemplation_no_checkbutton.pack(side="left", padx=2)

    contemplation_options_frame.pack(side="left", padx=2)
